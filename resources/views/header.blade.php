...
{{-- Navbar --}}
    <nav class="border-gray-200 bg-sky-600">  
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">  
            ...
            <div class="flex md:order-1">  
                ...
                <div class="relative hidden md:block">  
                    ...
                    <input type="text" id="search-navbar" class="block p-2 ps-10 text-sm text-black border border-gray-300 rounded-xl bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500 md:w-[600px]" placeholder="Search...">  
                </div>  
            </div>  
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">  
                ...
                <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">  
                    <a
                        href=""
                        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-gray-300 md:p-0 md:dark:text-gray-50">
                        Konten Edukasi
                    </a>
                    <a
                        href=""
